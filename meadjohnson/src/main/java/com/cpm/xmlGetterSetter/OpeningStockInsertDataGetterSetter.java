...
public class OpeningStockInsertDataGetterSetter {
	...
	String brand_cd, brand,sku_cd, sku,category_type,as_per_meccain, actual_listed, open_stock_cold_room, open_stock_mccaindf, totalfacing_mccaindf, open_stock_store_df, total_facing_storedf, material_wellness;
